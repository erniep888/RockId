...
```console
$ helm install --name event-logger-sql stable/mssql-linux --set acceptEula.value=Y --set edition.value=Developer --set sapassword=MyStrongPassword1234 --set service.port=1440
...
```
