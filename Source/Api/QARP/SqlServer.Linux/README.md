...
```console
$ helm install --name mymssql api-qarp-sql --set acceptEula.value=Y --set sapassword=Mypasswordis1234 --set persistence.enabled=false
...
```

```console
kubectl port-forward svc/mymssql-api-qarp-sql 49000:1434
```
